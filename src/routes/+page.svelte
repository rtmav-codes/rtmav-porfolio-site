                ...
                <div class="flex flex-col justify-center items-center p-10">
                    ...
                    <form target="_blank" action="https://formsubmit.co/rotem.avisar@gmail.com" method="POST" class="w-full">
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                <label for="subject" class="block text-sm font-medium pt-2">
                                    Subject
                                </label>
                            ...
                            <div class="sm:col-span-2 form-row">
                                <label for="message" class="block text-sm font-medium pt-2">
                                    Your message
                                </label>
                            ...
                            <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-gray-900 rounded-lg 
