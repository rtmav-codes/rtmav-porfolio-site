...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelte_video_player_kit: string;
	...
	export const npm_package_dependencies_svelte_magnifier: string;
	export const _CE_CONDA: string;
	export const npm_config_frozen_lockfile: string;
	export const PATH: string;
	export const npm_package_dependencies_svelte_photoswipe: string;
	...
	export const npm_package_dependencies_svelte_video_player: string;
	...
	export const npm_package_dependencies_photoswipe: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelte_video_player_kit: string;
		INIT_CWD: string;
		SHELL: string;
		TERM: string;
		...
		npm_package_dependencies_svelte_magnifier: string;
		_CE_CONDA: string;
		npm_config_frozen_lockfile: string;
		PATH: string;
		npm_package_dependencies_svelte_photoswipe: string;
		...
		npm_package_dependencies_svelte_video_player: string;
		LOGNAME: string;
		...
		npm_package_dependencies_photoswipe: string;
