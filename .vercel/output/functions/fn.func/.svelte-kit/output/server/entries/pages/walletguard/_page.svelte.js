  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<!----> <div class="w-screen h-auto bg-black flex flex-col justify-center items-center font-mono lg:px-0 px-5"><div class="flex flex-col justify-center items-center"><img src="/work/wallet-guard.png" class="w-36 mt-10" alt="s2mlogo"></div> <h1 class="text-white text-5xl mt-10">WalletGuard</h1> <h2 class="text-white text-2xl mt-2 text-center">Webflow Landing Page</h2> <div class="flex flex-col lg:w-3/4 w-full mt-10"><div class="flex flex-col justify-center items-center bg-black border rounded-xl lg:px-10 px-6 lg:py-0 py-10"><div class="flex flex-col justify-start items-start w-5/6"><h1 class="text-white lg:text-xl text-md mt-10 font-semibold">My Role: Frontend Developer</h1> <h2 class="text-white lg:text-lg text-md mt-5 font-semibold">Project Overview:</h2> <p class="text-white text-md">I took on the responsibility of crafting a compelling landing page using Webflow for a Web3 
                    ...
                    user's speech.</p> <ol class="list-decimal text-white text-md font-semibold lg:pl-10 pl-6 lg:mx-24 mx-1"><li><h3 class="mt-5 text-sm">Facial Movement Tracking with ARKit:</h3> <ul class="font-normal text-xs"><li>Utilized ARKit to precisely track facial movements, providing therapists with a detailed 
                                ...
                                improvement and track progress over time.</li></ul></li> <li><h3 class="mt-2 text-sm">Personalized Exercise Creation:</h3> <ul class="font-normal text-xs"><li>Designed an intuitive interface that allows therapists to create personalized exercise regimine 
                                tailored to individual patient needs.</li></ul></li> <li><h3 class="mt-2 text-sm">Objective Facial Asymmetry Tracking:</h3> <ul class="font-normal text-xs"><li>Incorporated objective measurements for facial asymmetry tracking, reducing the reliance on 
                                subjective assessments.</li> <li>Provided visual analytics and progress reports to therapists, enabling them to make data-driven 
                                decisions in the treatment process.</li></ul></li> <li><h3 class="mt-2 text-sm">Paperless Curriculum Management:</h3> <ul class="font-normal text-xs"><li>Integrated trust-building elements such as testimonials, case studies, or certifications to instill 
